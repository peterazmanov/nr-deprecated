:mod:`nr.misc.cli` --- Commandline interface wrapper
====================================================

.. module:: nr.misc.cli
  :synopsis: Commandline interface wrapper

The :mod:`~nr.misc.cli` module provides a convenient interface for implementing
wrappers for command-line interfaces. Here's a cool example that shows how you
can wrap ``ffmpeg``.
...
.. code:: python
  ...
  class ffmpeg(object):
    ...
    def __init__(self, bin_path='ffmpeg'):
      ...
      self.cli = nr.misc.cli.Cli(bin_path)
